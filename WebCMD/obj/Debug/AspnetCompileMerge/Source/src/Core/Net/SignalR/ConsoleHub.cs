...
namespace WebCMD.Core.Net.SignalR
{
    public class ConsoleHub : Hub
    {
        ...
        public void Request(string eventArgument, string connectionID)
        {
            ...
            //TODO: SERVER <-> Client connection cant be restored ??!
            ...
            if (Terminal.Instance(client.GUID).DebugMode)
        ...
        public override Task OnConnected()
        {
            ...
            Client client = Client.Join(guid, this.Context.ConnectionId, this.Respond);

            Debug.WriteLine(" (i) Connected " + client);

            //TODO: Add INIT EVENT !

            if (client.IsNew) Terminal.Instance(client.GUID).UpdateHeaderMessage(client);
