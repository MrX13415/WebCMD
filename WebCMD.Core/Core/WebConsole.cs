...
using WebCMD.Core.IO.Net;
using WebCMD.Core.Util.WebConfig;
...
namespace WebCMD.Core
{
    public partial class WebConsole
    {
        ...
        {
            get { return ConsoleManager.Session[typeof(WebConsole).FullName]; }
            set { ConsoleManager.Session[typeof(WebConsole).FullName] = value; }
        }
